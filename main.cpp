...
w1[bin];
        ...
        ifstrea    srand((unsigned)time(0));m infile1(infilename1);
        if(!infile1){
...
for(int t = 0; t<num2; t++){
    ...
    float      w2[bin];
     ...
     //input image2 data
        char infilename2[50] ;
		sprintf(infilename2, "C:\\Users\\dell\\Desktop\\EMD\\VOC-LAB\\image_data_%d.txt", t );
